...
import { Play, TrendingUp, Film, Tv, Star, Info } from 'lucide-react';
...
export default function MovieHome() {
  ...
  return (
    <div className="bg-[#202125] min-h-screen text-white pb-16">
      {/* Spotlight Carousel */}
      {spotlight && (
        <div className="relative w-full h-[55vh] md:h-[70vh] overflow-hidden mb-12 border-b border-white/5">
          ...
          <div className="absolute inset-x-0 bottom-0 max-w-7xl mx-auto px-4 pb-12 flex flex-col justify-end h-full">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <button 
                  onClick={() => navigate(`/movie/watch/${spotlight.id}${spotlight.media_type === 'tv' ? '/1/1' : ''}?type=${spotlight.media_type}`)}
